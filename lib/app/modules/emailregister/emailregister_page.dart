...
class EmailregisterPageState extends State<EmailregisterPage> {
  ...
  Widget userInput(TextEditingController userInput, String hintTitle,
      TextInputType keyboardType, bool check) {
    return Container(
      ...
      child: Padding(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            hintText: hintTitle,
            hintStyle: TextStyle(
                fontSize: 14, color: Colors.grey, fontStyle: FontStyle.normal),
          ),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      SizedBox(height: 45),
                      userInput(
                          nameController, 'Nome', TextInputType.name, false),
                      userInput(emailController, 'Email',
                          TextInputType.emailAddress, false),
                      userInput(senhaController, 'Senha',
